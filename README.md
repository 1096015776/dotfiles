...
My dotfiles base on JoosepAlviste,at first, i want to use fork to manage it,
but i find that some config is  unimportant for me,so I create a new git rep.
it is comportable for me. I suggest you that read his dotfiles.

Thanks for [JoosepAlviste](https://github.com/JoosepAlviste/dotfiles)
