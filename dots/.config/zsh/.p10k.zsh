# Generated by Powerlevel10k configuration wizard on 2022-11-26 at 21:34 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, vertical separators, blurred heads, round tails, 2 lines, solid, full frame,
# dark-ornaments, compact, many icons, fluent, transient_prompt,
